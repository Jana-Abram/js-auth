...
class SignupForm extends Form{
    ...
    FIELD_ERROR = {
      ...
      PASSWORD:'Пароль повинен складатися не менше з 8 символів, включаючи хоча б одну цифру, малу та велику літеру',
      PASSWORD_AGAIN:'Ваш другий пароль не збігаеться з першим',
      NOT_CONFIRM: 'Ви не поголжуєтесь з правилами',
